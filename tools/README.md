...
engine, periodic pings, and clean shutdown. It also records process memory on
systems with a compatible `/proc` entry. The native Piper workflow uses it for
25 syntheses on every initial platform.
