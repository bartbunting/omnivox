...
for repeat in range(a.repeats):
 ...
 for t,r in jobs:
  ...
  job={'audio_output':'null','cases':['line'],'concurrent':False,'flavour':'legacy','iterations':a.iterations,'mode':'warm','omnivox_root':plan['omnivox_root'],'rate':225,'replacement_burst':5,'route':r,'server':t['server'],'timeout':30,'warmups':3}
