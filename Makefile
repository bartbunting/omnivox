...
# Run tests
test: windows-helpers-test rate-audit-test latency-benchmark-test latency-benchmark-suite-test server-stress-test helper-soak-test diagnostics-redaction-test archive-safety-test
	cargo test --locked

rate-audit-test:
	PYTHONDONTWRITEBYTECODE=1 \
		$(PYTHON) -W error::ResourceWarning tools/test_audit_speech_rates.py
